...
public class LoanTransactionData {
    ...
    public LoanTransactionData getScaledValues() {
        this.amount = applyScale(this.amount);
        this.feeChargesPortion = applyScale(this.feeChargesPortion);
        this.fixedEmiAmount = applyScale(this.fixedEmiAmount);
        this.interestPortion = applyScale(this.interestPortion);
        this.outstandingLoanBalance = applyScale(this.outstandingLoanBalance);
        this.overpaymentPortion = applyScale(this.overpaymentPortion);
        this.unrecognizedIncomePortion = applyScale(this.unrecognizedIncomePortion);
        this.penaltyChargesPortion = applyScale(this.penaltyChargesPortion);
        this.principalPortion = applyScale(this.principalPortion);
